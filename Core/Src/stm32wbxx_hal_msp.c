...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    PA5     ------> SPI1_SCK
    */
    GPIO_InitStruct.Pin = MAG_MOSI_Pin|MAG_MISO_Pin;
    ...
    GPIO_InitStruct.Pin = MAG_CLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
    HAL_GPIO_Init(MAG_CLK_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA5     ------> SPI1_SCK
    */
    HAL_GPIO_DeInit(GPIOB, MAG_MOSI_Pin|MAG_MISO_Pin);

    HAL_GPIO_DeInit(MAG_CLK_GPIO_Port, MAG_CLK_Pin);
